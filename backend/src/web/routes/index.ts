...
class Routes {
    ...
    private registerRoutes() {
        ...
        const interactiveBuildingsController: InteractiveBuildingsController =
            new InteractiveBuildingsController(this.web.getCore())
        ...
        router.addRoute(
            RequestMethods.DELETE,
            '/region/:id/additionalBuilder/:builderId',
            async (request, response) => {
        ...
        router.addRoute(
            ...
            this.keycloak.protect('realm:mapadmin'),
            checkNewUser(this.web.getCore().getPrisma(), this.web.getCore())
        )
